...
(register-workflow-chain
  "wf2"                    ; from workflow name
  "wf3"                    ; to workflow name
  wf2-to-wf3-projector     ; projector function
  claim-manager-wf3)           ; next workflow's manager (WF3's manager)
