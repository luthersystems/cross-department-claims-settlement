...
(set 'state-spec
  (sorted-map
    ...
    "CLAIM_STATE_DOCMAGIC_REVIEWED"     (claim-docmagic-reviewed-state-handler)
    "CLAIM_STATE_SP_COMPLIANCE_OK"      (claim-sp-compliance-ok-state-handler)
    "CLAIM_STATE_SERVICENOW_APPROVED"   (claim-servicenow-approved-state-handler)
