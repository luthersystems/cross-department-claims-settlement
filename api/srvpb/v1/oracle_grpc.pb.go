...
const (
	CdcsService_UploadClaim_FullMethodName    = "/srvpb.v1.CdcsService/UploadClaim"
...
type CdcsServiceClient interface {
	UploadClaim(ctx context.Context, in *v1.UploadClaimRequest, opts ...grpc.CallOption) (*v1.UploadClaimResponse, error)
...
func (c *cdcsServiceClient) UploadClaim(ctx context.Context, in *v1.UploadClaimRequest, opts ...grpc.CallOption) (*v1.UploadClaimResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.UploadClaimResponse)
	err := c.cc.Invoke(ctx, CdcsService_UploadClaim_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CdcsServiceServer interface {
	UploadClaim(context.Context, *v1.UploadClaimRequest) (*v1.UploadClaimResponse, error)
...
func (UnimplementedCdcsServiceServer) UploadClaim(context.Context, *v1.UploadClaimRequest) (*v1.UploadClaimResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UploadClaim not implemented")
}
func (UnimplementedCdcsServiceServer) UploadClaimWF1(context.Context, *v1.UploadClaimWF1Request) (*v1.UploadClaimWF1Response, error) {
	return nil, status.Error(codes.Unimplemented, "method UploadClaimWF1 not implemented")
}
func (UnimplementedCdcsServiceServer) UploadClaimWF2(context.Context, *v1.UploadClaimWF2Request) (*v1.UploadClaimWF2Response, error) {
	return nil, status.Error(codes.Unimplemented, "method UploadClaimWF2 not implemented")
}
func (UnimplementedCdcsServiceServer) UploadClaimWF3(context.Context, *v1.UploadClaimWF3Request) (*v1.UploadClaimWF3Response, error) {
	return nil, status.Error(codes.Unimplemented, "method UploadClaimWF3 not implemented")
}
func (UnimplementedCdcsServiceServer) UploadClaimWF4(context.Context, *v1.UploadClaimWF4Request) (*v1.UploadClaimWF4Response, error) {
	return nil, status.Error(codes.Unimplemented, "method UploadClaimWF4 not implemented")
}
func (UnimplementedCdcsServiceServer) UploadClaimWF5(context.Context, *v1.UploadClaimWF5Request) (*v1.UploadClaimWF5Response, error) {
	return nil, status.Error(codes.Unimplemented, "method UploadClaimWF5 not implemented")
}
func (UnimplementedCdcsServiceServer) InvokeProcess(context.Context, *v1.InvokeProcessRequest) (*v1.InvokeProcessResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InvokeProcess not implemented")
}
func (UnimplementedCdcsServiceServer) GetClaimState(context.Context, *v1.GetClaimStateRequest) (*v1.GetClaimStateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetClaimState not implemented")
}
...
func RegisterCdcsServiceServer(s grpc.ServiceRegistrar, srv CdcsServiceServer) {
	// If the following call panics, it indicates UnimplementedCdcsServiceServer was
...
func _CdcsService_UploadClaim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.UploadClaimRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CdcsServiceServer).UploadClaim(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CdcsService_UploadClaim_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CdcsServiceServer).UploadClaim(ctx, req.(*v1.UploadClaimRequest))
	}
...
var CdcsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UploadClaim",
			Handler:    _CdcsService_UploadClaim_Handler,
		},
		{
